...
export const POKEMON_SPECIES: PokemonSpecies[] = [
  ...
  { id: 914, name: 'Meowscarada', types: ['Grass', 'Dark'] },
  { id: 917, name: 'Skeledirge',  types: ['Fire', 'Ghost'] },
  { id: 920, name: 'Quaquaval',   types: ['Water', 'Fighting'] },
  { id: 924, name: 'Lechonk',     types: ['Normal'] },
  { id: 931, name: 'Squawkabilly',types: ['Normal', 'Flying'] },
  { id: 937, name: 'Klawf',       types: ['Rock'] },
  { id: 940, name: 'Bombirdier',  types: ['Flying', 'Dark'] },
  { id: 942, name: 'Scovillain',  types: ['Grass', 'Fire'] },
  { id: 943, name: 'Rabsca',      types: ['Bug', 'Psychic'] },
  { id: 944, name: 'Flittle',     types: ['Psychic'] },
  { id: 947, name: 'Bramblin',    types: ['Grass', 'Ghost'] },
  { id: 950, name: 'Glimmet',     types: ['Rock', 'Poison'] },
  { id: 951, name: 'Glimmora',    types: ['Rock', 'Poison'] },
  { id: 952, name: 'Greavard',    types: ['Ghost'] },
  { id: 953, name: 'Houndstone',  types: ['Ghost'] },
  { id: 956, name: 'Armarouge',   types: ['Fire', 'Psychic'] },
  { id: 957, name: 'Ceruledge',   types: ['Fire', 'Ghost'] },
  { id: 960, name: 'Kingambit',   types: ['Dark', 'Steel'] },
  { id: 961, name: 'Great Tusk',  types: ['Ground', 'Fighting'] },
  { id: 962, name: 'Scream Tail', types: ['Fairy', 'Psychic'] },
  { id: 963, name: 'Brute Bonnet',types: ['Grass', 'Dark'] },
  { id: 964, name: 'Flutter Mane',types: ['Ghost', 'Fairy'] },
  { id: 965, name: 'Slither Wing',types: ['Bug', 'Fighting'] },
  { id: 966, name: 'Sandy Shocks',types: ['Electric', 'Ground'] },
  { id: 967, name: 'Iron Treads', types: ['Ground', 'Steel'] },
  { id: 968, name: 'Iron Bundle',  types: ['Ice', 'Water'] },
  { id: 969, name: 'Iron Hands',   types: ['Fighting', 'Electric'] },
  { id: 970, name: 'Iron Jugulis', types: ['Dark', 'Flying'] },
  { id: 971, name: 'Iron Moth',    types: ['Fire', 'Poison'] },
  { id: 972, name: 'Iron Thorns',  types: ['Rock', 'Electric'] },
  { id: 973, name: 'Frigibax',     types: ['Dragon', 'Ice'] },
  { id: 976, name: 'Baxcalibur',   types: ['Dragon', 'Ice'] },
  { id: 977, name: 'Gimmighoul',   types: ['Ghost'] },
  { id: 978, name: 'Gholdengo',    types: ['Steel', 'Ghost'] },
  { id: 979, name: 'Wo-Chien',     types: ['Dark', 'Grass'] },
  { id: 980, name: 'Chien-Pao',    types: ['Dark', 'Ice'] },
  { id: 981, name: 'Ting-Lu',      types: ['Dark', 'Ground'] },
  { id: 982, name: 'Chi-Yu',       types: ['Dark', 'Fire'] },
  { id: 983, name: 'Roaring Moon', types: ['Dragon', 'Dark'] },
  { id: 984, name: 'Iron Valiant', types: ['Fairy', 'Fighting'] },
  { id: 985, name: 'Koraidon',     types: ['Fighting', 'Dragon'] },
  { id: 986, name: 'Miraidon',     types: ['Electric', 'Dragon'] },
